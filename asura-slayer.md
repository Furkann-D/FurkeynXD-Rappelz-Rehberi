# ⚔️ Kan Tutkunu / Slayer Sınıf Rehberi

Slayer, Asura ırkının gizlilik, yüksek kaçınma (evasion), muazzam saldırı hızı (attack speed) ve ölümcül kritik hasar odaklı yakın dövüş (melee) sınıfıdır. Çift el silah kullanımı ve rakiplerini arkalarından yakalayarak saniyeler içinde eritmesiyle bilinir.
...
2.  **Kritik Güç (Crit Power):** Kritik hasarınızı arttırır.
3.  **Ruh taşlarınızı item slotlarınıza göre 2x CP 1x STR veya 2x CP 2x STR olarak takacaksınız.

---

## 🐾 En İyi Pet Kombinasyonları (Kemer ve Sahada)

Potansiyelini en üst düzeye çıkarmak için tercih edilmesi gereken petler:

### Kemer (Belt) Yuvaları İçin:
...
## 💡 Slayer İçin Oynanış İpuçları

*   **Gizlilik Avantajı:** Savaşa girmeden önce gizlilik yeteneklerinizi kullanarak düşmana yaklaşın. İlk vuruş her zaman kritik veya sersemletici (stun) etkiye sahip olmalıdır.
*   **Saldırı Hızı Sınırları (Breaks):** Ekipmanlarınızı ve petlerinizi öyle ayarlayın ki saldırı hızı animasyonunuz bir üst kademeye (speed break) ulaşsın. Slayer ne kadar hızlı vurursa, o kadar çok can çalar ve hayatta kalır.
...
🔙 [Irklar ve Sınıflar Menüsüne Dön](siniflar-ve-irklar.md) | 🏠 [Ana Sayfaya Dön](README.md)
