# 🐾 Evcil Hayvan (Pet) Sistemi Rehberi

Rappelz'i diğer MMORPG oyunlarından ayıran en büyük özellik son derece gelişmiş evcil hayvan (pet) sistemidir. Bu rehberde petlerinizi nasıl evcilleştireceğinizi, geliştireceğinizi ve onlardan en yüksek verimi nasıl alacağınızı öğreneceksiniz.

---

## 1. Evcilleştirme (Taming) Nasıl Yapılır?
...
## 2. Pet Türleri ve Nadirlik Seviyeleri

Rappelz dünyasındaki petler nadirliklerine göre kategorize edilir. Nadirlik arttıkça petin temel özellikleri ve yetenekleri de güçlenir:

| Nadirlik | Örnek Petler |
| :--- | :--- |
| **Mormal** | Pantera, Poultry, Tortus |
| **Olağan (Common)** | Blue Pixie, Orc, Skeleton, Siren, Forest Pixie, etc... |
| **Olağan Özel (Basic)** | Unicorn, Salamander, Hawkman, Nightmare, Harpy |
| **Nadir (Rare)** | Kentauros, Naga, Gnoll, Angel, Kainen |
| **Efsanevi (Legendary)** | Stone Golem, Cerberus |
| **Eşsiz (Unique)** | White Dragon, Death Tyrant, Wind Pixie, Bloodthirsty Slaughter, Minotaurus etc... |
| **Epic** | Death Gladiator, Grandmaster Hector |
---

## 3. Pet Evrimi (Evolution)

Petleriniz seviye atladıkça görünüşleri değişir ve güçlenirler. Toplamda 3 evrim aşaması vardır:
*   **Evrim 1 (E1):** Seviye 1 - 60 arası (Genç aşama).
*   **Evrim 2 (E2):** Seviye 60'de evrimleştirilebilir (Yetişkin aşama).
